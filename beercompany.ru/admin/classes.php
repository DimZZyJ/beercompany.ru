    ...
    class shop {
		...
		function show(){
			...
			echo '<div id="places" style="background-color: #792701;border: 2px solid gray;">
					<table >
						<tr><td>ID:'.$this->id.'</td><td><img src="https://burobiz-a.akamaihd.net/uploads/images/8939/large___________3.jpg" height="100" width="100"></td> <td>'.$this->adress.'</td> <td> 88005553536</td><td>'.$_status.'</td><td><img '.$_statusCheck.' alt="X" height="10" width="10"></td></tr>
					</table>
				 	</div>';
		}
